VERSION 5.00
Begin VB.Form frm_ADM_DetGuias_Sob 
   Caption         =   "Detalle de Guías - Sobrantes"
   ClientHeight    =   6555
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9855
   ...
   End
End
Attribute VB_Name = "frm_ADM_DetGuias_Sob"
...
Set ODyn = objEntrega.ListaCabGuia_Sob(num, objUsuario.CodigoLocal)
ODyn.MoveFirst
...
Set Me.ctlgrdguias.DataSource = objEntrega.ListaDetGuia_Sob(num, Busca, objUsuario.CodigoLocal)
SeteaGrilla
