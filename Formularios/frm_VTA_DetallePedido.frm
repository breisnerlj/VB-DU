...
'    Right:   -4152
    ...
    With oSheet.Range("A9:F9")
        .Value = Array("Código", "Items", "Descripción", "Unidad", "Unitario", "Total")
        .HorizontalAlignment = -4131
        .Borders.LineStyle = 1
    End With
...
'    Next
    ...
    arrayInfo2(2, 1) = "Se realiza el envio ,previa verificación  x horario y zona de cobertura"
    arrayInfo2(3, 1) = "Las cotizaciones son realizadas en base al stock de nuestro Almacen"
    arrayInfo2(4, 1) = "No realizamos entrega de ficha técnica .Rs"
    arrayInfo2(5, 1) = "Forma de pago:"
    arrayInfo2(6, 1) = "* Efectivo"
    arrayInfo2(7, 1) = "*Transferencia bancaria"
    arrayInfo2(8, 1) = "*Tarjetas de crédito"
    arrayInfo2(9, 1) = "*Abono en cheque"
    arrayInfo2(10, 1) = "Una vez realizado el abono en cheque ,enviarnos los datos de la transacción realizada ,"
    arrayInfo2(11, 1) = "las misma que es remitida a nuestro Dpto de Contabilidad(la verificación demora en ser visualizadas"
    arrayInfo2(12, 1) = "hasta 3 días utiles) .Con la confirmacion de nuestro Dpto de Contabilidad ,se coordina inmediatamente con Ud"
...
Private Sub cargaDetalle(Optional vstrCodigoLocal As String, Optional vstrNumeropedido As String)
    ...
    arrCaption = Array("Codigo", "Descripción", _
                       "Cantidad", "Frac.", _
                       "PVP", "D.N.", _
                       "P.V.Px", "SubTotal")
...
Private Sub CargaFormaPago(Optional vstrCodigoLocal As String, Optional vstrNumeropedido As String)
    ...
    arrCaption = Array("Descripción", _
                       "Detalle", _
                       "Verificación", _
                       "Pagado", _
                       "T/C", _
