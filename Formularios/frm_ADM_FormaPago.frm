...
Begin VB.Form frm_ADM_FormaPago 
   Caption         =   "Modificacion de Forma de Pago"
   ClientHeight    =   6870
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8580
   Icon            =   "frm_ADM_FormaPago.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   6870
   ScaleWidth      =   8580
   ...
   Begin TrueDBGrid70.TDBGrid GrdListaFP 
      ...
      Splits(0)._ColumnProps(78)=   "Column(16).Width=2725"
      Splits(0)._ColumnProps(79)=   "Column(16).DividerColor=0"
      Splits(0)._ColumnProps(80)=   "Column(16)._WidthInPix=2646"
      ...
      _StyleDefs(164) =   "Named:id=33:Normal"
      _StyleDefs(165) =   ":id=33,.parent=0"
      _StyleDefs(166) =   "Named:id=34:Heading"
      _StyleDefs(167) =   ":id=34,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(168) =   ":id=34,.wraptext=-1"
      _StyleDefs(169) =   "Named:id=35:Footing"
      _StyleDefs(170) =   ":id=35,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(171) =   "Named:id=36:Selected"
      _StyleDefs(172) =   ":id=36,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(173) =   "Named:id=37:Caption"
      _StyleDefs(174) =   ":id=37,.parent=34,.alignment=2"
      _StyleDefs(175) =   "Named:id=38:HighlightRow"
      _StyleDefs(176) =   ":id=38,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(177) =   "Named:id=39:EvenRow"
      _StyleDefs(178) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
      _StyleDefs(179) =   "Named:id=40:OddRow"
      _StyleDefs(180) =   ":id=40,.parent=33"
      _StyleDefs(181) =   "Named:id=41:RecordSelector"
      _StyleDefs(182) =   ":id=41,.parent=34"
      _StyleDefs(183) =   "Named:id=42:FilterBar"
      _StyleDefs(184) =   ":id=42,.parent=33"
   End
   ...
   End
End
Attribute VB_Name = "frm_ADM_FormaPago"
...
Private Sub Form_Load()
    ...
    Set grdFormaPago.DataSource = ObjFormaPago.ListaFPagoTipMaquina(objUsuario.TipoMaquina)
    Call SeteaGrilla
...
Private Sub SeteaGrilla()
  ...
  Dim arrAlineacion As Variant
    ...
    Next i
    grdFormaPago.Columns("COD_FORMA_PAGO").Visible = True
