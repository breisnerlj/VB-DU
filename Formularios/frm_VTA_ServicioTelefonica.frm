VERSION 5.00
Begin VB.Form frm_VTA_ServicioTelefonica 
   BorderStyle     =   0  'None
   ClientHeight    =   7245
   ClientLeft      =   2715
   ClientTop       =   3420
   ...
   Begin VB.CommandButton cmdAceptar 
      ...
      Height          =   615
      Left            =   4440
      Picture         =   "frm_VTA_ServicioTelefonica.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   6240
      Width           =   1095
   ...
   Begin VB.CommandButton cmdCancelar 
      ...
      Height          =   615
      Left            =   5745
      Picture         =   "frm_VTA_ServicioTelefonica.frx":058A
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   6240
      Width           =   1095
   ...
   Begin VB.Image Image1 
      Height          =   240
      Left            =   60
      Picture         =   "frm_VTA_ServicioTelefonica.frx":0B14
      Top             =   60
      Width           =   240
   End
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      Caption         =   "Servicios - Telefónica"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   11.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_VTA_ServicioTelefonica"
...
''''''Public Sub Datos(ByVal strTipo As String, ByVal strDescripcion As String)
''''''On Error GoTo handle
''''''strCodigoPadre = strTipo
''''''strDescripcionPadre = strDescripcion
''''''Me.Show
''''''
''''''    Exit Sub
''''''handle:
