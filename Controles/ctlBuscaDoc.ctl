VERSION 5.00
Begin VB.UserControl ctlBuscaDoc 
   ClientHeight    =   1185
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2940
 ...
 Dim strCodCnvEnBTLPROD As String
    ...
    If KeyAscii = 13 Then
        ...
        If odynC.RecordCount <= 0 Then
            ...
            Set odynCdocumentos = objDocumento.Lista_CDocumentos(Trim(TxtBusca.Text), strOpt, objUsuario.CodigoLocal)
        End If
        ...
        If odynD.RecordCount <= 0 Then
            ...
            Set odynDdocumentos = objDocumento.Lista_DDocumentos(Trim(TxtBusca.Text), strOpt)
        End If
